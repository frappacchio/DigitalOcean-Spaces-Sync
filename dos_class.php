...
class DOS
{
    ...
    public function register_scripts()
    {
        ...
        wp_enqueue_script('dos-core-js', plugin_dir_url(__FILE__) . '/assets/scripts/core.js', array('jquery'), '1.4.0',
            true);
    ...
    public function test_connection()
    {
        ...
        try {
            ...
            $this->show_message(__('Connection is not established.',
                    'dos') . ' : ' . $e->getMessage() . ($e->getCode() == 0 ? '' : ' - ' . $e->getCode()), true);
            exit();
    ...
    public function file_delete($file)
    {
        ...
        if ($this->storage_file_delete == 1) {
            ...
            try {
                ...
                $filesystem = DOS_Filesystem::get_instance($this->key, $this->secret, $this->container,
                    $this->endpoint);
